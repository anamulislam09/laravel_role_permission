                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="permissions[]" {{App\Models\User::roleHasPermissions($role, $permissions) ? 'checked' : '';}} id="chackPermissionAll">
                            ...
                            <div class="row">
                                @foreach ($permissions as $permission )
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input type="checkbox" name="permissions[]" {{$role->hasPermissionTo($permission->name) ? 'checked' : ''}} value="{{$permission->name}}" id="permission{{$permission->id}}">
